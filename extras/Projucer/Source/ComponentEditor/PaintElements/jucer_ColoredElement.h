...
//==============================================================================
/**
    Base class for paint elements that have a fill color and stroke.

*/
class ColoredElement   : public PaintElement
{
public:
    ColoredElement (PaintRoutine* owner,
                     const String& name,
    ...
    void getColorSpecificProperties (Array<PropertyComponent*>& props);
    ...
    //==============================================================================
    void addColorAttributes (XmlElement* const e) const;
    bool loadColorAttributes (const XmlElement& xml);
