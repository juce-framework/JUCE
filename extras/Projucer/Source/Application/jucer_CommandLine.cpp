    ...
    */
    ...
    static void showHelp()
    {
        ...
        std::cout << appName << std::endl
                  ...
                  << "defaultJuceModulePath, defaultUserModulePath, vstLegacyPath, aaxPath (not valid on linux), rtasPath (not valid on linux), araPath (not valid on linux), androidSDKPath or androidNDKPath. " << std::endl
                  << std::endl
