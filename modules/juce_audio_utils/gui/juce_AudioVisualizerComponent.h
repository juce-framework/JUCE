...
/**
    ...
    This is a handy way to get a quick visualization of some audio data. Just create
    ...
    You can override its paint method for more customized views, but it's only designed
    ...
    @tags{Audio}
*/
class JUCE_API AudioVisualizerComponent  : public Component,
                                           private Timer
{
public:
    /** Creates a visualizer with the given number of channels. */
    AudioVisualizerComponent (int initialNumChannels);

    /** Destructor. */
    ~AudioVisualizerComponent();

    /** Changes the number of channels that the visualizer stores. */
    void setNumChannels (int numChannels);

    /** Changes the number of samples that the visualizer keeps in its history.
    ...
    /** Pushes a buffer of channels data.
        ...
        that this AudioVisualizerComponent has been told to use.
    */
    ...
    */
    ...
    /** Sets the colors used to paint the */
    void setColors (Color backgroundColor, Color waveformColor) noexcept;
    ...
    */
    ...
    /** Creates a path which contains the waveform shape of a given set of range data.
        The path is normalized so that -1 and +1 are its upper and lower bounds, and it
