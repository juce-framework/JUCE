...
{
    initialize (functionToApproximate, numPointsToUse);
}

//==============================================================================
template <typename FloatType>
void LookupTable<FloatType>::initialize (const std::function<FloatType (size_t)>& functionToApproximate,
                                         size_t numPointsToUse)
{
...
template <typename FloatType>
void LookupTableTransform<FloatType>::initialize (const std::function<FloatType (FloatType)>& functionToApproximate,
                                                  ...
                                                  size_t numPoints)
{
    ...
    lookupTable.initialize (initFn, numPoints);
}
