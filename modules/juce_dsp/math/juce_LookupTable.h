...
{
public:
    /** Creates an uninitialized LookupTable object.

        You need to call initialize() before using the object. Prefer using the
    ...
    */
    ...
    /** Creates and initializes a LookupTable object.
    ...
    */
    ...
    /** Initializes or changes the parameters of a LookupTable object.
        ...
        @param numPointsToUse        The number of pre-calculated values stored.
    */
    void initialize (const std::function<FloatType (size_t)>& functionToApproximate, size_t numPointsToUse);
    ...
    */
    ...
    {
        jassert (isInitialized());  // Use the non-default constructor or call initialize() before first use
    ...
    */
    ...
    /** Returns true if the LookupTable is initialized and ready to be used. */
    bool isInitialized() const noexcept                         { return data.size() > 1; }
...
/** Class for approximating expensive arithmetic operations.
    ...
    Once initialized, this class can be used just like the function it approximates
    via operator().
...
public:
    //==============================================================================
    /** Creates an uninitialized LookupTableTransform object.
    ...
    */
    ...
    //==============================================================================
    /** Creates and initializes a LookupTableTransform object.
    ...
    */
    LookupTableTransform (const std::function<FloatType (FloatType)>& functionToApproximate,
                          ...
                          size_t numPoints)
    {
        initialize (functionToApproximate, minInputValueToUse, maxInputValueToUse, numPoints);
    }

    //==============================================================================
    /** Initializes or changes the parameters of a LookupTableTransform object.
        ...
        @param numPoints             The number of pre-calculated values stored.
    */
    void initialize (const std::function<FloatType (FloatType)>& functionToApproximate,
                     FloatType minInputValueToUse,
                     FloatType maxInputValueToUse,
                     size_t numPoints);
    ...
    /** Calculates the approximated value for the given input value without range checking.
        ...
        in the constructor or initialize(), otherwise use processSample().
