...
//==============================================================================
#if JUCE_MAC
 extern void juce_initializeMacMainMenu();
#endif

bool JUCEApplication::initializeApp()
{
    if (JUCEApplicationBase::initializeApp())
    {
       #if JUCE_MAC
        juce_initializeMacMainMenu(); // (needs to get the app's name)
       #endif
