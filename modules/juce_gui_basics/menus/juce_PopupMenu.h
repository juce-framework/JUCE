...
*/
  ...
  */
      ...
      */
       ...
       */
          JUCE_NODISCARD Options withSelectableAreaLeftInset (int xInsetAmount) const;
          ...
          @note Added by Tim for FAW SampleComboBox.h so that we could prevent
                ...
                the item.
      */
          JUCE_NODISCARD Options withSelectableAreaRightInset (int xInsetAmount) const;
      ...
      */
          ...
          /** Gets the left inset (x) amount used to determine mouse clicks that
          select PopupMenu items. A click with an X less than this value will
          not select the PopupMenu item.
          ...
          @note Added by Tim for FAW SampleComboBox.h so that we could prevent
                ...
                from selecting the item.
       */
          int getSelectableAreaLeftInset() const noexcept              { return selectableAreaLeftInset; }

          /** Gets the right inset (x) amount used to determine mouse clicks that
          select PopupMenu items. A click with an X greater than this value will
          not select the PopupMenu item.

          @see withItemThatMustBeVisible

          @note Added by Tim for FAW SampleComboBox.h so that we could prevent
                the sample favorite buttons in the SamplePopMenuItem
                from selecting the item.
       */
          int getSelectableAreaRightInset() const noexcept             { return selectableAreaRightInset; }
