...
public:
    ...
    */
    ...
    /** Recursively replaces a color that might be used for filling or stroking.
        return true if any instances of this color were found.
    */
    virtual bool replaceColor (Color originalColor, Color replacementColor);
