...
public:
    ...
    */
    enum ColorIds
    {
        backgroundColorId          = 0x100e801,    /**< The color to fill the background of the button area. */
        outlineColorId             = 0x100e803,    /**< The color to use to draw an outline around the text area. */
    };
