...
public:
    ...
    */
    ...
    //==============================================================================
    /** A set of color IDs to use to change the color of various aspects of the list.
    ...
    */
    enum ColorIds
    {
        highlightColorId          = 0x1000540, /**< The color to use to fill a highlighted row of the list. */
        textColorId               = 0x1000541, /**< The color for the text. */
        highlightedTextColorId    = 0x1000542  /**< The color with which to draw the text in highlighted sections. */
    };
