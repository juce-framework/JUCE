...
//==============================================================================
/** Contains classes for different types of physics behaviors - these classes
    are used as template parameters for the AnimatedPosition class.
*/
namespace AnimatedPositionBehaviors
{
    /** A non-snapping behavior that allows the content to be freely flicked in
    ...
    */
    ...
    //==============================================================================
    /** A behavior that gravitates an AnimatedPosition object towards the nearest
