...
bool X11Symbols::loadAllSymbols()
{
    ...
    if (! loadSymbols (xLib, xextLib,
                       ...
                       makeSymbolBinding (xUtf8LookupString,           "Xutf8LookupString"),
                       ...
                       makeSymbolBinding (xFilterEvent,                "XFilterEvent"),
                       makeSymbolBinding (xOpenDisplay,                "XOpenDisplay"),
                       makeSymbolBinding (xSetLocaleModifiers,         "XSetLocaleModifiers"),
                       makeSymbolBinding (xRegisterIMInstantiateCallback, "XRegisterIMInstantiateCallback"),
                       makeSymbolBinding (xUnregisterIMInstantiateCallback, "XUnregisterIMInstantiateCallback"),
                       makeSymbolBinding (xOpenIM,                     "XOpenIM"),
                       makeSymbolBinding (xCloseIM,                    "XCloseIM"),
                       makeSymbolBinding (xSetIMValues,                "XSetIMValues"),
                       makeSymbolBinding (xCreateIC,                   "XCreateIC"),
                       makeSymbolBinding (xDestroyIC,                  "XDestroyIC"),
                       makeSymbolBinding (xSetICFocus,                 "XSetICFocus"),
                       makeSymbolBinding (xUnsetICFocus,               "XUnsetICFocus"),
                       makeSymbolBinding (xSetICValues,                "XSetICValues"),
                       makeSymbolBinding (xVaCreateNestedList,         "XVaCreateNestedList"),
