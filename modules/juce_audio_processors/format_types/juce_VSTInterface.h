...
enum VstIndividualSpeakerType
{
    ...
    vstIndividualSpeakerTypeCenter,
    vstIndividualSpeakerTypeLFE,
    vstIndividualSpeakerTypeLeftSurround,
    vstIndividualSpeakerTypeRightSurround,
    vstIndividualSpeakerTypeLeftCenter,
    vstIndividualSpeakerTypeRightCenter,
    vstIndividualSpeakerTypeSurround,
    vstIndividualSpeakerTypeCenterSurround = vstIndividualSpeakerTypeSurround,
    ...
    vstIndividualSpeakerTypeTopFrontCenter,
    vstIndividualSpeakerTypeTopFrontRight,
    vstIndividualSpeakerTypeTopRearLeft,
    vstIndividualSpeakerTypeTopRearCenter,
