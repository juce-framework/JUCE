...
private:
    ...
    {
        AudioProcessorARAExtension* araPlugInInstance = dynamic_cast<AudioProcessorARAExtension*>(pluginInstance);
        return araPlugInInstance->createARAPlugInExtension (documentControllerRef, knownRoles, assignedRoles);
    }
