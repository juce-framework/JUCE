...
namespace AAXClasses
{
    ...
    static void getPlugInDescription (AAX_IEffectDescriptor& descriptor, bool isEnhancedAudioSuite = false)
    {
        ...
        ScopedPointer<AudioProcessor> plugin = createPluginFilterOfType (aaxType);
