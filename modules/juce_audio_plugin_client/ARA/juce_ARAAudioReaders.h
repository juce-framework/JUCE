...
public:
    /** Use a std::vector<ARAPlaybackRegion*> to construct a playback region reader. 
        ...
        Note that while it's possible to construct a reader this way, it's preferable to use the
        ARADocumentController::createPlaybackRegionReader factory function and have the 
        document controller construct the \p playbackRenderer instance. 
    */
...
public:
    /** Use an ARARegionSequence to construct a region sequence reader. 
        ...
        Note that while it's possible to construct a reader this way, it's preferable to use the
        ARADocumentController::createRegionSequenceReader factory function and have the
        document controller construct the \p playbackRenderer instance.
    */
