...
public:
          ...
          ascent (0), descent (0), heightToPointsFactor (1.0f)
    {
        ...
        typeface = GlobalRef (android.activity.callObjectMethod (JUCE_ANDROID_ACTIVITY_CLASSNAME.getTypeFaceFromAsset,
        ...
        : Typeface (String(), String())
    {
        ...
        typeface = GlobalRef (android.activity.callObjectMethod (JUCE_ANDROID_ACTIVITY_CLASSNAME.getTypeFaceFromByteArray, bytes.get()));
    ...
    EdgeTable* getEdgeTableForGlyph (int glyphNumber, const AffineTransform& t, float /*fontHeight*/) override
    {
        ...
        jintArray maskData = (jintArray) android.activity.callObjectMethod (JUCE_ANDROID_ACTIVITY_CLASSNAME.renderGlyph, (jchar) glyphNumber, paint.get(), matrix, rect.get());
