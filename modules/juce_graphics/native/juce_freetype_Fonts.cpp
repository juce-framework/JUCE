...
public:
                                                                  ...
                                                                  font.getTypefaceStyle()))
    {
        if (faceWrapper != nullptr)
            initializeCharacteristics (font.getTypefaceName(),
                                       font.getTypefaceStyle());
    }
    ...
    {
        if (faceWrapper != nullptr)
            initializeCharacteristics (faceWrapper->face->family_name,
                                       faceWrapper->face->style_name);
    }

    void initializeCharacteristics (const String& fontName, const String& fontStyle)
    {
