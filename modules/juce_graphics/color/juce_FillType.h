...
//==============================================================================
/**
    Represents a color or fill pattern to use for rendering paths.

    This is used by the Graphics and DrawablePath classes as a way to encapsulate
    a brush type. It can either be a solid color, a gradient, or a tiled image.
...
public:
    ...
    /** Creates a fill type of a solid color.
        @see setColor
    */
    FillType (Color color) noexcept;
    ...
    */
    ...
    //==============================================================================
    /** Returns true if this is a solid color fill, and not a gradient or image. */
    bool isColor() const noexcept          { return gradient == nullptr && image.isNull(); }
    ...
    /** Turns this object into a solid color fill.
    ...
    void setGradient (const ColorGradient& newGradient);
    ...
    */
    ...
    /** Changes the opacity that should be used.
        If the fill is a solid color, this just changes the opacity of that color. For
        gradients and image tiles, it changes the opacity that will be used for them.
    */
    void setOpacity (float newOpacity) noexcept;

    /** Returns the current opacity to be applied to the color, gradient, or image.
        @see setOpacity
    */
    float getOpacity() const noexcept       { return color.getFloatAlpha(); }
    ...
    */
    ...
    /** The solid color being used.
        ...
        If the fill type is not a solid color, the alpha channel of this color indicates
    ...
    */
    ...
    /** Returns the gradient that should be used for filling.
        ...
        is indicated by the alpha channel of the color variable.
    */
    ScopedPointer<ColorGradient> gradient;
