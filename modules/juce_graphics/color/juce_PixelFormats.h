...
{
public:
    /** Creates a pixel without defining its color. */
    PixelARGB() noexcept {}
    ~PixelARGB() noexcept {}
    ...
    //==============================================================================
    /** Copies another pixel color over this one.

        This doesn't blend it - this color is simply replaced by the other one.
    */
    ...
    //==============================================================================
    /** Sets the pixel's color from individual components. */
    ...
    */
    ...
    /** Blends another pixel with this one, creating a color that is somewhere
    ...
    */
    ...
    //==============================================================================
    /** Replaces the color's alpha value with another one. */
    forcedinline void setAlpha (const uint8 newAlpha) noexcept
    {
        components.a = newAlpha;
    }

    /** Multiplies the color's alpha value with another one. */
    ...
    //==============================================================================
    /** The indexes of the different components in the byte layout of this type of color. */
  #if JUCE_ANDROID
   #if JUCE_BIG_ENDIAN
