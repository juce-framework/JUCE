...
#include "juce_graphics/image_formats/libwebp/src/dsp/dsp.h"
...
#include "juce_graphics/image_formats/libwebp/src/utils/filters_utils.h"
#include "juce_graphics/image_formats/libwebp/src/utils/quant_levels_utils.h"
