...
public:
    ...
    enum JointStyle
    {
        mitered,    /**< Indicates that corners should be drawn with sharp joints.
                         ...
                         miter could require extending the point too far away from the
                         path, so a miter limit is imposed and any corners that exceed it
                         are drawn as beveled instead. */
