...
public:
    ...
    */
    ...
    /** Returns a parallelogram that has been scaled by the given amount, centered around the origin. */
    ...
    /** Scales this parallelogram by the given amount, centered around the origin. */
    template <typename PointOrScalarType>
