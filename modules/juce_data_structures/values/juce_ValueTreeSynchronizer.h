...
/**
    ...
    synchronized by transmitting encoded changes over some kind of transport
    mechanism.

    To use it, you'll need to implement a subclass of ValueTreeSynchronizer
    ...
    @tags{DataStructures}
*/
class JUCE_API  ValueTreeSynchronizer  : private ValueTree::Listener
{
public:
    /** Creates a ValueTreeSynchronizer that watches the given tree.
    ...
    */
    ValueTreeSynchronizer (const ValueTree& tree);

    /** Destructor. */
    virtual ~ValueTreeSynchronizer();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (ValueTreeSynchronizer)
};
